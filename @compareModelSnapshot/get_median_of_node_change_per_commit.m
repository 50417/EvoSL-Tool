...
median_query = ['SELECT distinct change_type,'...
                    ...
                    ' FROM ('...
                    ' SELECT'... 
                    ' Before_project_sha, After_project_sha,'...      
                    ' CASE'...  
                    ...
                    ' FROM (	'... 
                    ' SELECT Before_project_sha, After_project_sha, is_deleted, is_added, is_modified, is_renamed, count(*) as totalCount'... 
                    ' FROM ' char(obj.table_name) ...
                    ' WHERE( is_deleted = 1 or is_added = 1 or is_modified = 1 or is_renamed = 1 ) '...
                    ' AND node_type = "' nodetype '"'...
                    ' GROUP BY Before_project_sha, After_project_sha, is_deleted, is_added, is_modified, is_renamed) '...
